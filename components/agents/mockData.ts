...
export const SHORT_TASK_LIST = `
1. [gpt-4][context] Write a two-paragraph short story about horses.
2. [eleven-labs] Create voice narration for the two paragraphs.
3. [gpt-4][image] Create a prompt for an image that corresponds to the story.
4. [dall-e] Generate the image using the prompt.
`;

export const ONLY_IMAGE_TASK_LIST = `
1. [gpt-4][image] Create a prompt for any image.
2. [dall-e] Generate the image using the prompt.
`;
