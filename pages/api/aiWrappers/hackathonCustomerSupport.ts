...
export const hackathonCustomerSupport = async (
  res: NextApiResponse,
  message: string
) => {
      ...
      messages: [
        {
          role: "system",
          content:
            "You are helping a customer support representative provide better answers. You will be given a user message, and provide an answer that will be given to a customer service representative. That representative may or may not present your exact message to the user.",
        },
        {
          role: "user",
          content: message,
